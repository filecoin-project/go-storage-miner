...
func (f *fakeNode) WaitForSelfDeals(ctx context.Context, msg cid.Cid) (dealIds []uint64, err error) {
...
func (f *fakeNode) WaitForProveCommitSector(ctx context.Context, msg cid.Cid) (processedAtBlockHeight uint64, err error) {
